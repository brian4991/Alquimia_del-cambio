...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="fixed top-0 w-full bg-white/80 backdrop-blur-lg shadow-elegant z-50 border-b border-stone-200/50 transition-all duration-300">
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-start items-center">
          <div className="flex items-center space-x-2 sm:space-x-4 animate-fade-in">
            ...
            />
            <div>
              <h1 className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-sage-600 to-sage-700 bg-clip-text text-transparent">
                Retiro Renacer
              </h1>
              <p className="text-[10px] sm:text-xs text-taupe-600 font-medium">Cambio de Paradigma</p>
            </div>
          </div>
        </div>
      </header>
      ...
      {/* Date & Location */}
      <section className="py-12 sm:py-20 relative overflow-hidden" style={{backgroundColor: '#F5F5F0'}}>
        ...
        <div className="container mx-auto max-w-5xl text-center px-4 sm:px-6 relative z-10">
          <Card className="bg-white/90 backdrop-blur-sm shadow-elegant hover:shadow-sage border-2 border-sage-200 transition-all duration-300 hover:scale-102">
            <CardContent className="p-6 sm:p-8 md:p-10">
              <h2 className="text-xl sm:text-3xl md:text-5xl font-bold bg-gradient-to-r from-sage-700 via-sage-600 to-taupe-600 bg-clip-text text-transparent tracking-tight leading-tight">
      ...
      {/* Why This Retreat */}
      <section className="py-16 sm:py-24" style={{backgroundColor: '#F9F6F3'}}>
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-center text-gray-800 mb-12 sm:mb-20 tracking-tight">
            ...
            <CardContent className="p-6 sm:p-10 md:p-12">
              <div>
                <div className="text-center mb-8 sm:mb-10">
                  <p className="text-gray-600 mb-3 sm:mb-4 text-base sm:text-lg font-medium">Residentes en Francia o fuera</p>
                  <p className="text-2xl sm:text-3xl text-gray-400 line-through mb-2 sm:mb-3">€199 EUR</p>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-stone-50 to-white">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          <h2 className="text-2xl sm:text-4xl md:text-6xl font-bold text-center text-gray-800 mb-12 sm:mb-20 tracking-tight">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <Card className="overflow-hidden shadow-2xl hover:shadow-sage transition-all duration-300 border-0">
              <CardHeader className="bg-gradient-to-br from-sage-600 to-sage-700 text-white pb-6 sm:pb-8">
                <CardTitle className="text-2xl sm:text-3xl font-bold text-center">
                ¿QUÉ INCLUYE?
                </CardTitle>
              </CardHeader>
              <CardContent className="p-5 sm:p-8 bg-gradient-to-b from-sage-50/30 to-white">
            ...
            <Card className="overflow-hidden shadow-2xl hover:shadow-elegant transition-all duration-300 border-0">
              <CardHeader className="bg-gradient-to-br from-taupe-600 to-taupe-700 text-white pb-6 sm:pb-8">
                <CardTitle className="text-2xl sm:text-3xl font-bold text-center">
                ¿QUÉ ESPERAR?
                </CardTitle>
              </CardHeader>
              <CardContent className="p-5 sm:p-8 bg-gradient-to-b from-taupe-50/30 to-white">
                <div className="space-y-4 sm:space-y-5">
                {[
      ...
      <section className="py-16 sm:py-24" style={{backgroundColor: '#e8e4df'}}>
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
      ...
      {/* Why We're Different */}
      <section className="py-16 sm:py-24" style={{backgroundColor: '#f4f2ed'}}>
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-center text-gray-800 mb-12 sm:mb-20 tracking-tight">
      ...
      {/* Founder Section */}
      <section className="py-16 sm:py-24 relative overflow-hidden" style={{backgroundColor: '#F5F5F0'}}>
            ...
            <Card className="bg-white/95 backdrop-blur-sm shadow-elegant hover:shadow-sage border-2 border-sage-200 transition-all duration-300">
              <CardContent className="p-6 sm:p-8">
                <div className="mb-5 sm:mb-6">
                  ...
                  <h3 className="text-xl sm:text-3xl md:text-4xl font-semibold bg-gradient-sage bg-clip-text text-transparent">
                    Soy Nicole Ramírez
                  </h3>
      ...
      {/* Testimonials */}
      <section className="py-16 sm:py-24 relative overflow-hidden" style={{backgroundColor: '#FDFCFB'}}>
        <div className="absolute inset-0 bg-gradient-to-br from-lavender-50/30 via-transparent to-sage-50/30" />
        <div className="container mx-auto max-w-6xl px-4 sm:px-6 relative z-10">
          <div className="text-center mb-12 sm:mb-20">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-sage-700 to-taupe-600 bg-clip-text text-transparent mb-3 sm:mb-4 tracking-tight">
              Testimonios
            </h2>
            <p className="text-lg sm:text-xl text-gray-600">Lo que ellas vivieron</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            {[
              {
      ...
      {/* FAQ Section */}
      <section className="py-16 sm:py-24" style={{backgroundColor: '#F5F5F0'}}>
        ...
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 text-center relative z-10">
          <div className="animate-fade-in">
            ...
            <div className="space-y-2 sm:space-y-3 mb-8 sm:mb-10">
              <p className="text-lg sm:text-2xl text-white/95">
