...
const Login = () => {
  ...
  return (
    <div 
      className="min-h-screen flex items-center justify-center py-8 sm:py-12 px-3 sm:px-4 md:px-6 lg:px-8 relative overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8 relative z-10">
        ...
        <div className="text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-inter font-bold text-white mb-3 sm:mb-4 px-4">
            Cambio de Paradigma
          </h1>
          <p className="text-sage-200 text-base sm:text-lg px-4">
            Bienvenido a tu viaje de transformación
          </p>
        </div>

        {/* Login Container */}
        <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-10 border border-sage-200">
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-sage-800 mb-2">
              Inicia Sesión
            </h2>
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center py-3 sm:py-4 px-4 sm:px-6 border-2 border-sage-300 rounded-lg sm:rounded-xl shadow-lg bg-white text-sm sm:text-base font-medium text-sage-700 hover:bg-sage-50 hover:border-sage-400 transition-all duration-200 transform hover:scale-105"
          >
            ...
            <span className="ml-2 sm:ml-3 text-base sm:text-lg">Continuar con Google</span>
          </button>

          {/* Dev Mode Indicator */}
          {isLocalMode && (
            <div className="mt-3 sm:mt-4 text-center">
              <span className="inline-block px-2 sm:px-3 py-1 bg-yellow-100 text-yellow-800 text-xs font-medium rounded-full">
                🔧 Modo Desarrollo
              </span>
            </div>
          )}
        ...
        <div className="text-center px-4">
          <p className="text-white text-sm sm:text-base lg:text-lg italic font-light">
